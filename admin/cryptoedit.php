...
if (isset($_POST['submit'])) {
    ...
    if ($status == "failed") {
        ...
        $newearn = $userSu['bonus'] + $usereu['amount'];
        $newbal = $userSu['balance'] + $usereu['amount'];
        $sqlcoin = "UPDATE users set balance ='$newbal', pending_withdrawal = '$newpend' WHERE id='$userid'";
        $querycoin = mysqli_query($conn, $sqlcoin);

    }
    if ($status == "completed") {
        $newtw = $userSu['withdrawal'] + $usereu['amount'];
                ...
                <div class="box box-primary">
                    ...
                    <form action="" method="post" role="form">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputeth">Account</label>
                                <input type="text" name="account" class="form-control" id="exampleInputeth"
                                    value="<?php echo $usereu['account']; ?>" readonly>
                            </div>
